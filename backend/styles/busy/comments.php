...
$commentsquery = "SELECT * FROM comments WHERE post_id = '$post_id' AND STATUS = 'approved' ORDER BY timestamp DESC";
        ...
        <label><small>Email Address</small></label>
				<p><input type=\"text\" name=\"email\" size=\"40\" tabindex=\"1\" value=\"".$email."\" id=\"email\" /></p>
				<label><small>Website</small></label>
				<p><input type=\"text\" name=\"site\" size=\"40\" tabindex=\"1\" value=\"".$site."\" id=\"site\" /></p>
        <label><small>Comment(s)</small></label>
				<p><textarea name=\"comment\" cols=\"50\" rows=\"5\" id=\"response\">".$comment."</textarea></p>
