<?php
    ...
    $categoryquery = "SELECT * FROM posts WHERE (categories = '$category_id' OR categories LIKE '%, $category_id' OR categories LIKE '$category_id,%') AND (status = 'published') ORDER BY timestamp DESC LIMIT 0, 10";
