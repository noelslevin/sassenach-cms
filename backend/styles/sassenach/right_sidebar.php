...
<p><input type="text" name="search" size="40" tabindex="6" id="search" /></p>

<div class="center"><input type="submit" tabindex="7" value="Search <?php echo $sitename; ?>" name="sitesearch" /></div>
